...
class ContentFeatureExtractor(nn.Module):
    ...
    def __init__(self, img_size=224, kernel_size=16, wv_planes=128):
        ...
        # patch pooling
        if img_size == 224 and kernel_size ==8:
            ...
            self.patch_pool_avg = nn.AdaptiveAvgPool2d((28, 28))
            self.patch_pool_max = nn.AdaptiveMaxPool2d((28, 28))

        expected_patch_num = 28 ** 2  # 224//8 = 28
